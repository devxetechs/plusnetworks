...
class ResPartner(models.Model):
    ...
    agent_type = fields.Selection([("agent", "External agent")], string="Type", default="agent")
    commission_id = fields.Many2one(string="Commission", comodel_name="sale.commission", help="This is the default commission used in the sales where this agent is assigned. It can be changed on each operation if needed.")
    settlement = fields.Selection([("monthly", "Monthly"), ("quaterly", "Quarterly"), ("semi", "Semi-annual"), ("annual", "Annual")], string="Settlement period", default="monthly",)
